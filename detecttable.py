...
def box_extraction(img_for_box_extraction_path, cropped_dir_path):
    ...
    thresh, img_bin = cv2.threshold(img, 200, 255,cv2.THRESH_BINARY )  # Thresholding the image
    ...
    (thresh, img_final_bin) = cv2.threshold(img_final_bin, 200, 255, cv2.THRESH_BINARY )
    ...
    # for value in allRect:
        ...
        # for box in allRect:
            ...
            # xmax1=box[2]
            # ymax1=box[3]
            # if xmin != xmin1 or ymin != ymin1 or xmax != xmax1 or ymax != ymax1:
                # if abs(ymin1-ymin)<10 and abs(ymax1-ymax)< 10:
                    # cv2.rectangle(img,(xmin,ymin),(xmax,ymax),(0,255,255),1)
        
        
    cv2.imwrite("detectTable.jpg",img)

box_extraction("image\\page12.JPG", "data/")